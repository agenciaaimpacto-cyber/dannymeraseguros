#!/usr/bin/env python3
"""
Sincroniza los carruseles generados por la tarea automática de Danny Mera Seguros
...
Danny haya guardado a mano en esa misma carpeta del día).
"""
import hashlib
import re
import shutil
...
REPO = Path("/Users/danny/DannyMeraSeguros")
